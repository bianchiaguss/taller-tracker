...
- Si el usuario dice "hazlo asi", hazlo asi.
...
- No digas "Voy a leer el archivo, luego modificar...". Solo hazlo.
...
- Si ya editaste un archivo, no copies el resultado en tu respuesta.

## 13. No usar Agent cuando Grep/Read basta
- Agent solo para busquedas amplias o tareas complejas.
